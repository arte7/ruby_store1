...
class PurchasesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create purchase" do
    assert_difference('Purchase.count') do
      post purchases_url, params: { purchase: { product_id: @purchase.product_id, quantity: @purchase.quantity } }
    end
  ...
  test "should update purchase" do
    patch purchase_url(@purchase), params: { purchase: { product_id: @purchase.product_id, quantity: @purchase.quantity } }
